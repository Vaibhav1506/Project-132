...
Original file is located at
    https://colab.research.google.com/drive/1rzDK-Vp7aRVZTOpyPi4Kg0S73fbcium3
"""
...
planet_masses_low_gravity = []
planet_radii_low_gravity = []
planet_type_low_gravity = []

for v in low_gravity_planet:
  planet_masses_low_gravity.append(v[3])
  planet_radii_low_gravity.append(v[7])
  planet_type_low_gravity.append(v[6])

fig = px.scatter(x = planet_radii_low_gravity, y = planet_masses_low_gravity, color = planet_type_low_gravity)
fig.show()

favourable_planet_for_living = []

for w in low_gravity_planet:
  if w[6] == "Super Earth" or w[6] == "Terrestrial":
    favourable_planet_for_living.append(w)

print(len(favourable_planet_for_living))
print(favourable_planet_for_living)